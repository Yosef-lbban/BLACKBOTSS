...
local NameUser = "[- BLacK 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/Yousef_Labban1)\n — — — — — — — — —\n❈ 🇸🇦︙بواسطه -› ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = "[- BLacK 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/Yousef_Labban1)\n — — — — — — — — —\n❈ 🇸🇦︙اسم المستخدم -› ["..data.first_name_.."](T.me/"..UserName..")"
if status == "lock" then
...
send(msg.chat_id_, msg.id_,"[- BLacK 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/Yousef_Labban1)\n — — — — — — — — —\n❈ 🇸🇦︙العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "Yousef_Labban1")..")".."\n❈ 🇸🇦︙تم رفعه "..RTPA.." هنا\n")
...
if BLACKBOTSSrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"[- BLacK 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/Yousef_Labban1)\n — — — — — — — — —\n❈ 🇸🇦︙العضو -› ["..result.title_.."](t.me/"..(text1[3] or "Yousef_Labban1")..")".."\n❈ 🇸🇦︙تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."BLACKBOTSS:Special:User"..msg.chat_id_,result.id_)  
...
database:set(bot_id.."BLACKBOTSS:Set:Cmd:Group:New1"..msg.chat_id_..":تعط","تعطيل الايدي بالصورة")
database:sadd(bot_id.."BLACKBOTSS:List:Cmd:Group:New"..msg.chat_id_,"تعط")
database:set(bot_id.."BLACKBOTSS:Set:Cmd:Group:New1"..msg.chat_id_..":تفع","تفعيل الايدي بالصورة")
...
local UserName = (b.username_ or "Yousef_Labban1")
...
if text == (database:get(bot_id.."BLACKBOTSS:Name:Bot") or "يوسف") then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
Namebot = (database:get(bot_id.."BLACKBOTSS:Name:Bot") or "يوسف")
local namebot = {
...
if text == "تفعيل الاذاعة" and DevBLACKBOTSS(msg) then  
database:del(bot_id.."BLACKBOTSS:Status:Bc") 
send(msg.chat_id_, msg.id_,"\n❈ 🇸🇦︙تم تفعيل الاذاعة " ) 
return false
end 
if text == "تعطيل الاذاعة" and DevBLACKBOTSS(msg) then  
...
if text == "تنظيف القروبات" and DevBLACKBOTSS(msg) then
...
os.execute('wget https://raw.githubusercontent.com/Yosef-lbban/BLACKBOTSS/master/BLACKBOTSS.lua')
os.execute('wget https://raw.githubusercontent.com/Yosef-lbban/BLACKBOTSS/master/start.lua')
...
if text and text:match("^زخرفة (.*)$") and database:get(bot_id.."BLACKBOTSS:zhrf_Bots"..msg.chat_id_) == "open" then
...
if DevBLACKBOTSS(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Yosef-lbban/files_BLACKBOTSS/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/Yosef-lbban/files_BLACKBOTSS/master/files_BLACKBOTSS/"..file)
if res == 200 then
...
if text == 'حذف رسالة المطور' and DevBLACKBOTSS(msg) then
database:del(bot_id..'BLACKBOTSS:Text_Dev')
send(msg.chat_id_, msg.id_,'❈ 🇸🇦︙ تم حذف رسالة المطور')
end
if text == 'وضع رسالة المطور' and DevBLACKBOTSS(msg) then
...
send(msg.chat_id_,msg.id_,'❈ 🇸🇦︙شترك في قناة السورس اولآ @Yousef_Labban1 .')   
return false 
end
key = {
...
send(msg.chat_id_, msg.id_,'❈ 🇸🇦︙عدد اعضاء المجموعة اقل من *~ {'..(database:get(bot_id..'BLACKBOTSS:Num:Add:Bot') or 0)..'* عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
...
x = {} 
x.inline_keyboard = {
{{text = '❈ 🇸🇦︙ BLacK 𝖲𝗈𝗎𝗋𝖼𝖾  .',url='http://t.me/Yousef_Labban1'}},
}
...
inline = {
{{text = '❈ 🇸🇦︙ BLacK 𝖲𝗈𝗎𝗋𝖼??  .',url='http://t.me/Yousef_Labban1'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
...
local Name_Bot = (database:get(bot_id.."BLACKBOTSS:Name:Bot") or "يوسف")
